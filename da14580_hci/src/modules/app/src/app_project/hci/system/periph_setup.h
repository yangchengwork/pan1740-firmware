...
/****************************************************************************************/ 
...
#ifdef CFG_HCI_SPI
    #ifndef CFG_HCI_UART
    #ifndef CFG_HCI_BOTH_EIF
        #define SPI_CLK_PORT        GPIO_PORT_0
        #define SPI_CS_PORT         GPIO_PORT_0
        #define SPI_DO_PORT         GPIO_PORT_0
        #define SPI_DI_PORT         GPIO_PORT_0
        #define SPI_DREADY_PORT     GPIO_PORT_0
        ...
        #define SPI_DREADY_PORT     GPIO_PORT_2
...
#define HCI_EIF_SELECT_PORT	GPIO_PORT_0
#define HCI_EIF_SELECT_PIN	GPIO_PIN_7
...
#ifdef CFG_HCI_SPI 
#define SPI_GPIO_PORT       SPI_CS_PORT
#else
...
#ifndef CFG_HCI_UART
#ifndef CFG_HCI_SPI
#error "YOU MUST DEFINE CFG_HCI_UART or CFG_HCI_SPI !!!!!"
#endif
#endif
...
#define SPI_FLASH_WORD_MODE  0      // 0: 8-bit, 1: 16-bit, 2: 32-bit, 3: 9-bit
#define SPI_FLASH_SMN_MODE   0      // 0: Master mode, 1: Slave mode
#define SPI_FLASH_POL_MODE   1      // 0: SPI clk initially low, 1: SPI clk initially high
#define SPI_FLASH_PHA_MODE   1      // If same with SPI_POL_MODE, data are valid on clk high edge, else on low
#define SPI_FLASH_MINT_EN    0      // (SPI interrupt to the ICU) 0: Disabled, 1: Enabled
#define SPI_FLASH_CLK_DIV    2      // (SPI clock divider) 0: 8, 1: 4, 2: 2, 3: 14
#define SPI_FLASH_CS_PIN     3      // Define Chip Select pin
